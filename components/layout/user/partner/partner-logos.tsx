...
const partners = [
    { name: "Partner 1", logo: "/img/Unisma.png" },
    { name: "Partner 2", logo: "/img/Logo Polinema.png" },
    { name: "Partner 3", logo: "/img/Logo UM.png" },
    { name: "Partner 4", logo: "/img/Logo UB.png" },
    { name: "Partner 5", logo: "/img/brawijaya multi usaha.jpg" },
    { name: "Partner 6", logo: "/img/KAI.png" },
    { name: "Partner 7", logo: "/img/Logo-BTN.png" },
    { name: "Partner 8", logo: "/img/Logo Pegadaian.png" },
    { name: "Partner 9", logo: "/img/Logo UIN Malang.png" },
];
