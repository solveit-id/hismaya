...
export default function Hero() {
    ...
    const [Sector, setSector] = useState("Pilih Bidang");
    ...
    const categories = ["Nasional", "Internasional", "ISO"];

    const nationalSector = [
        "K3",
                ...
                >
                    ...
                    >
                        <div className="relative w-full max-w-[540px] lg:flex lg:flex-col lg:justify-center">
                            ...
                            >
                                Tingkatkan{" "}
                                <span className="text-[#078fd3]">Kompetensi</span> Raih{" "}
                                <span className="text-[#078fd3]">Karier</span> Profesional
                            </motion.h1>
                    ...
                    >
                        ...
                        >
                            <Image
                                src="/img/Hero.png"
                                alt="Ilustrasi pengembangan kompetensi profesional"
                                width={680}
                                height={588}
                                className="
                                h-auto
