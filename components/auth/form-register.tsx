    ...
    <div>
      ...
      >
        ...
        <div>
            ...
            <input type="text" name="name" placeholder="Full Name" className='bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5' />
        ...
        <div>
            ...
            <input type="email" name="email" placeholder="example@gmail.com" className='bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5' />
            <div aria-live='polite' aria-atomic='true'>
