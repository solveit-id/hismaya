...
export default function BundlingPackage() {
    ...
    >
        <div className="mx-auto max-w-[1040px]">
            ...
            >
                <span className="rounded-lg bg-[#078fd3] px-5 py-1.5 text-[15px] font-extrabold text-white shadow-[0_7px_14px_rgba(7,143,211,0.18)]">
                    Penawaran Spesial
                </span>

                <h2 className="mt-3 text-[34px] font-extrabold sm:text-[40px]">
                    Paket <span className="text-[#078fd3]">Bundling</span> Kami
                </h2>
            </div>
            ...
            <div className="mt-[94px] grid items-end justify-items-center gap-x-[54px] gap-y-14 md:grid-cols-3">
                {packages.map((item, index) => {
                    ...
                    >
                        <BackgroundShape index={index} active={isActive} />
                        ...
                        >
                            ...
                            <a href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
                                `Halo Admin, saya ingin mendaftar paket bundling "${item.name}". Mohon informasi lebih lanjut.`
                                )}`}
                                target="_blank"
